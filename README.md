<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/brand/variant/01/cover-dark.png">
  <img alt="donly" src="assets/brand/variant/01/cover-light.png" width="640">
</picture>
